...
(function ($) {
  ...
  EditableForm.prototype = {
      ...
      **/        
      ...
      error: function(msg) {
          var $group = this.$form.find('.form-control'),
          ...
          if(msg === false) {
              ...
              if(msg) {
                  ...
                  msg = '<i class="fa fa-times-circle" aria-hidden="true"></i> '+lines.join('<br>');
              }
  ...
  */      
  ...
  '</div>'+'<div class="editable-error-block"></div>'+'<div class="editable-buttons"></div></div>'+
  '</div>'+ 
  '</form>';
...
(function ($) {
  ...
  $.extend($.fn.editableform.Constructor.prototype, {
      initTemplate: function() {
          this.$form = $($.fn.editableform.template); 
          this.$form.find('.form-control').addClass('form-group');
  ...
  //error classes
  $.fn.editableform.errorGroupClass = 'is-invalid';
