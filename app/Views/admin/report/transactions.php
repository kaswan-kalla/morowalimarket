...
<div class="main-content">
    <div class="container-fluid py-4">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4"><div class="card shadow-sm"><div class="card-body text-center"><small class="text-muted">Total Transaksi</small><h4 class="fw-bold text-primary" id="trxCount">0</h4></div></div></div>
            <div class="col-md-4"><div class="card shadow-sm"><div class="card-body text-center"><small class="text-muted">Total Nilai</small><h4 class="fw-bold text-success" id="trxValue">Rp 0</h4></div></div></div>
            <div class="col-md-4"><div class="card shadow-sm"><div class="card-body text-center"><small class="text-muted">Pembayaran Terverifikasi</small><h4 class="fw-bold text-info" id="trxVerified">0</h4></div></div></div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead class="table-light">
                            <tr><th>No. Pesanan</th><th>Pembeli</th><th>Toko</th><th>Metode Bayar</th><th>Total</th><th>Status Bayar</th><th>Status Pesanan</th><th>Tanggal</th></tr>
                        </thead>
...
$('#filterForm').on('submit', function(e) { e.preventDefault(); loadTransactions(); });
