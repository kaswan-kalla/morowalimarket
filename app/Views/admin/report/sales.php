...
<div class="main-content">
    <div class="container-fluid py-4">
        ...
        <div class="row g-3 mb-4" id="summaryCards">
            <div class="col-md-3">
                <div class="card shadow-sm bg-success text-white">
                    <div class="card-body"><small>Total Penjualan</small>
                        <h4 class="fw-bold" id="totalSales">Rp 0</h4>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm bg-primary text-white">
                    <div class="card-body"><small>Total Pesanan</small>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm bg-warning text-white">
                    <div class="card-body"><small>Rata-rata per Pesanan</small>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm bg-info text-white">
                    <div class="card-body"><small>Produk Terjual</small>
                        <h4 class="fw-bold" id="totalItems">0</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <h6 class="fw-bold mb-3">Grafik Penjualan</h6><canvas id="salesChart" height="80"></canvas>
            </div>
        </div>
    ...
    function loadReport() {
        ...
        $.get('<?= base_url('admin/reports/sales-data') ?>', params, function(res) {
            ...
            chart = new Chart(document.getElementById('salesChart'), {
                type: 'bar',
                data: {
                    labels: (d.chart || []).map(c => c.date),
                    datasets: [{
                        label: 'Penjualan (Rp)',
                        data: (d.chart || []).map(c => c.total),
